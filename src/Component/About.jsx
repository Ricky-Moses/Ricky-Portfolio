        ...
        <div className="about-container px-2 h-75">
          ...
          <table>
            <tbody>
              ...
              <tr><th>Email: </th><td className='link-primary' style={{cursor: "pointer"}} onClick={()=> scrollToSection('contact')}>rickymoses08122003@gmail.com</td></tr>
              <tr><th>Github Link: </th><td><a className='link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover' href="https://github.com/Ricky-Moses" target='_blank'>Link</a></td></tr>
            </tbody>
          </table>
